...
ttk.Button(app, text = 'isko click karo',command = abc, font=('Arial',15)).place(x=100,y=110)
ttk.Button(app,text = 'Ye wala bhe hai', font=('Arial',15),command = lambda:msg.set('pata nahi')).place(x=100,y=160)
